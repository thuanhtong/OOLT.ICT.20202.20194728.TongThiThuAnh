...
public class DiskTest {
	public static void main(String[] args) throws PlayerException {
		...
		DigitalVideoDisc dvd20= new DigitalVideoDisc("Star Wars", "Science Fiction", "George", 87, 24.95f);
		DigitalVideoDisc dvd21=null;
		System.out.println(dvd19.equals(dvd20));
		System.out.println(dvd19.compareTo(dvd21));
	}
}
